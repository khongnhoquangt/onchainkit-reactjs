...
function Badge({ className, tooltip = false }) {
  ...
  return /* @__PURE__ */ jsxDEV("div", { className: "relative inline-flex", "data-testid": "ockBadgeContainer", children: [
    /* @__PURE__ */ jsxDEV(
      "span",
      {
        className: cn(
      ...
      false,
      {
        fileName: "/Users/MAC/Documents/Code/onchainkit-react/src/identity/components/Badge.tsx",
        lineNumber: 52,
        columnNumber: 7
      },
      this
    ),
    showTooltip && tooltip && /* @__PURE__ */ jsxDEV(
      "div",
      {
        className: cn(
          border.radius,
