...
function WalletDropdownFundLink({
  ...
  const linkContent = useMemo(
    () => (
      ...
      /* @__PURE__ */ jsxDEV("span", { className: cn(!fundingUrlToRender && pressable.disabled), children: [
        /* @__PURE__ */ jsxDEV("div", { className: "-translate-y-1/2 absolute top-1/2 left-4 flex h-[1.125rem] w-[1.125rem] items-center justify-center", children: iconSvg }, void 0, false, {
          fileName: "/Users/MAC/Documents/Code/onchainkit-react/src/wallet/components/WalletDropdownFundLink.tsx",
          lineNumber: 63,
          columnNumber: 9
        }, this),
  ...
  return /* @__PURE__ */ jsxDEV("button", { type: "button", className: overrideClassName, onClick: handleClick, children: linkContent }, void 0, false, {
    fileName: "/Users/MAC/Documents/Code/onchainkit-react/src/wallet/components/WalletDropdownFundLink.tsx",
    lineNumber: 86,
    columnNumber: 5
  }, this);
