    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxDEV(
          ...
          false,
          {
            fileName: "/Users/MAC/Documents/Code/onchainkit-react/src/swap/components/SwapAmountInput.tsx",
            lineNumber: 108,
            columnNumber: 7
          },
          this
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "flex w-full items-center justify-between", children: [
          ...
          sourceTokenOptions.length > 0 ? /* @__PURE__ */ jsxDEV(
            TokenSelectDropdown,
            {
              token: source.token,
            ...
            this
          ) : source.token && /* @__PURE__ */ jsxDEV(TokenChip, { className: pressable.inverse, token: source.token }, void 0, false, {
            fileName: "/Users/MAC/Documents/Code/onchainkit-react/src/swap/components/SwapAmountInput.tsx",
            lineNumber: 140,
            columnNumber: 13
          }, this)
        ...
        /* @__PURE__ */ jsxDEV("div", { className: "mt-4 flex w-full items-center justify-between", children: [
          /* @__PURE__ */ jsxDEV("div", { className: cn(text.label2, color.foregroundMuted), children: formatUSD(amountUSD) }, void 0, false, {
            fileName: "/Users/MAC/Documents/Code/onchainkit-react/src/swap/components/SwapAmountInput.tsx",
            lineNumber: 145,
            columnNumber: 9
          }, this),
          /* @__PURE__ */ jsxDEV(
            "div",
            {
              ...
              children: [
                balance && /* @__PURE__ */ jsxDEV("span", { children: `Balance: ${getRoundedAmount(balance, 8)}` }, void 0, false, {
                  fileName: "/Users/MAC/Documents/Code/onchainkit-react/src/swap/components/SwapAmountInput.tsx",
                  lineNumber: 155,
                  columnNumber: 23
                }, this),
                type === "from" && address && /* @__PURE__ */ jsxDEV(
                  "button",
                  {
                    type: "button",
                    className: cn(
