...
import { ArgList, Arguments, Argv, Category, Command as BaseCommandConfig, Flag, ListType, MapOptionConfig, MapParamConfig, MultipleOption, Option, OptionConfig, OptionConfigMap, Param, ParamConfig, ParamConfigList, ParserOptions, PrimitiveType, ScalarType, SingleOption, UnknownOptionMap, ValueType } from '@boost/args';
import { Loggable, LoggerFunction } from '@boost/log';
import { INTERNAL_INITIALIZER } from './constants';
export type { ArgList, Arguments, Argv, Category, Flag, ListType, MultipleOption, Option, OptionConfig, OptionConfigMap, Param, ParamConfig, ParamConfigList, ParserOptions, PrimitiveType, ScalarType, SingleOption, UnknownOptionMap, ValueType, };
...
export type Middleware = (argv: Argv, parse: MiddlewareCallback, logger: Loggable) => MiddlewareArguments | Promise<MiddlewareArguments>;
export type StyleType = 'default' | 'failure' | 'info' | 'inverted' | 'muted' | 'notice' | 'success' | 'warning';
export type ThemePalette = {
    [T in StyleType]: string;
};
