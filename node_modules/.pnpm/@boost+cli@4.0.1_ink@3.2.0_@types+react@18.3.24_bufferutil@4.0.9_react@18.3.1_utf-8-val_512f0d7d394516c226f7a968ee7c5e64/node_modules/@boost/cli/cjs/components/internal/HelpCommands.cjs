...
const formatCommandCall = require('../../helpers/formatCommandCall.cjs');
...
function HelpCommands({
  ...
  const categorizedCommands = React.useMemo(() => groupByCategory.groupByCategory(items, categories ?? {}), [categories, items]);
...
//# sourceMappingURL=HelpCommands.cjs.map
