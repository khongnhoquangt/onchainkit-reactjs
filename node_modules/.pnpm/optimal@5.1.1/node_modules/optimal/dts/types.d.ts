...
export declare type DefaultValueInitializer<T> = (path: string, currentObject: UnknownObject, rootObject: UnknownObject) => T;
export declare type DefaultValue<T> = DefaultValueInitializer<T> | T;
export declare type ValueComparator<T> = (value: T, currentObject?: UnknownObject, rootObject?: UnknownObject) => boolean;
...
export declare type CriteriaValidator<Input> = (value: Input, path: string, options: SchemaValidateOptions) => unknown;
export interface Criteria<Input> {
    dontSkipIfNull?: boolean;
    dontSkipIfUndefined?: boolean;
    validate: CriteriaValidator<Input>;
}
export declare type CriteriaFactory<Input> = (state: SchemaState<Input>, ...args: any[]) => Criteria<Input> | void;
...
export interface SchemaValidateOptions<RO extends object = UnknownObject, CO extends object = UnknownObject> {
...
export declare type InferSchemaType<T> = T extends Schema<infer U> ? U : never;
export declare type Blueprint<T extends object> = {
...
export declare type DeepPartial<T> = T extends Builtin | Primitive | unknown[] ? T : T extends object ? {
