...
export { OptimalError, ValidationError, array, arrayCriteria, blueprint, bool, booleanCriteria, classCriteria, commonCriteria, createPredicate, createSchema, custom, date, dateCriteria, func, id, instance, lazy, number, numberCriteria, object, objectCriteria, optimal, record, regex, schema, index as schemas, shape, shapeCriteria, string, stringCriteria, tuple, tupleCriteria, union, unionCriteria, uuid };
